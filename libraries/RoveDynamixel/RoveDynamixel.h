...
void DynamixelWrite(Dynamixel dyna, uint8_t dynamixelRegister, uint8_t* data, uint8_t dataLength);
uint8_t DynamixelRead(Dynamixel dyna, uint8_t dynamixelRegister, uint8_t readLength, uint8_t* dataBuffer);
