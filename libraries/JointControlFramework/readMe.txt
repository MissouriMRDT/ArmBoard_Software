 ...
 *
 *   Framework description here: https://github.com/MST-MRDT/ArmBoardSoftware/wiki/Joint-control-framework-overview
 ...
 *
 *   Files: The AbstractFramework files are the top level abstract classes that form the backbone of the framework. 
 *   Enums, constants, and macros are kept in FrameworkUtilities file. The rest of the files are derivatives of the abstract classes; include the ones your program specifically uses.
 *
